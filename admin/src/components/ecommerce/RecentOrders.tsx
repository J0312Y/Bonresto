    ...
    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 border-gray-800 bg-white/[0.03] sm:px-6">
      <div className="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <button className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 border-gray-700 bg-gray-800 text-gray-400 hover:bg-white/[0.03] hover:text-gray-200">
            <svg
              className="stroke-current fill-white fill-gray-800"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
        ...
        <Table>
          ...
          <TableHeader className="border-gray-100 border-gray-800 border-y">
            <TableRow>
              <TableCell
                isHeader
                className="py-3 font-medium text-gray-500 text-start text-theme-xs text-gray-400"
              >
                Products
              </TableCell>
              <TableCell
