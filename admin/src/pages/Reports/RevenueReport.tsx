  ...
  return (
    <>
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white/90">Rapport des revenus</h2>
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
          <div className="px-6 pt-5 pb-3">
            <h3 className="text-base font-semibold text-gray-800 dark:text-white/90">Détail par restaurant</h3>
          </div>
