  ...
  return (
    <>
      ...
      <div className="mb-4 flex items-end justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white/90">Clés de licence</h2>
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader className="border-gray-100 dark:border-gray-800 border-y">
                <TableRow>
                  <TableCell isHeader className="py-3 px-6 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Client</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Clé</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Clé statut</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Abonnement</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Plan · Coût</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Expire le</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Activée le</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Révoquée le</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400">Serveur</TableCell>
                  ...
                  return (
                    <TableRow key={lic.key_id} className={isRevoked || isExpired ? "opacity-60" : ""}>
                      ...
                      <TableCell className="py-3">
                        <div className="flex items-center gap-2">
                          <code className={`rounded px-2 py-1 text-xs font-mono tracking-wider ${
                            isRevoked
                              ? "bg-red-50 text-red-400 dark:bg-red-900/20 line-through"
                      ...
                      <TableCell className="py-3">
                        {lic.plan_name ? (
                          <div>
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{lic.plan_name}</span>
                            <br />
