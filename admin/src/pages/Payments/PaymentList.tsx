  ...
  return (
    <>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 text-white/90">Paiements</h2>
          <p className="text-sm text-gray-500 text-gray-400">
            {payments.length} transaction{payments.length !== 1 ? "s" : ""}
            {" · "}
            Total encaissé : <strong className="text-gray-700 text-gray-200">{fmt(total)}</strong>
          </p>
        </div>
      </div>
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader className="border-gray-100 border-gray-800 border-y">
                <TableRow>
                  <TableCell isHeader className="py-3 px-6 font-medium text-gray-500 text-theme-xs text-gray-400">#</TableCell>
                  ...
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs text-gray-400">Montant</TableCell>
                  <TableCell isHeader className="py-3 font-medium text-gray-500 text-theme-xs text-gray-400">Date</TableCell>
              ...
              <TableBody className="divide-y divide-gray-100 divide-gray-800">
                {payments.map((p) => (
                  <TableRow key={p.payment_id}>
                    ...
                    <TableCell className="py-3 font-semibold text-gray-800 text-white/90">
                      {fmt(p.amount)}
                    </TableCell>
                    <TableCell className="py-3 text-gray-500 text-theme-sm text-gray-400">
