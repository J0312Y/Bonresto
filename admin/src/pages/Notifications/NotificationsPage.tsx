    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-700"
        >
      ...
      {!loading && shown.length > 0 && (
        <div className="flex flex-col gap-3">
          {shown.map((n) => {
            ...
            <div
              key={n.id}
              className={`bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 border-l-4 ${isRead ? "border-l-gray-200 dark:border-l-gray-600" : (COLOR_BORDER[n.color] ?? "border-l-gray-300")} shadow-sm overflow-hidden`}
            >
              ...
              {/* Footer link */}
              <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-2 bg-gray-50 dark:bg-gray-900/30">
                <Link
