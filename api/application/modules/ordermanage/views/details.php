	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-2 text-left mb-display">
                                    ...
                                    if ($orderinfo->order_status == 1) {echo display('pending_order');} else

                                    if ($orderinfo->order_status == 2) {echo display('processing_order');} else

                                    if ($orderinfo->order_status == 5) {echo display('cancel');} else

                                    if ($orderinfo->order_status == 4) {echo display('served');}
	                        ...
	                        <div class="table-responsive m-b-20">
                                        ...
                                        foreach ($addons as $addonsid) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><strong><?php
                                                    ...
                                                    if ($currency->position == 2) {echo $currency->curr_icon;} ?> </strong>
                                                </td>
                                            </tr>
                                            <?php $y++;
                                        }
                                ...
                                ?>
                                    ...
                                    if (empty($taxinfos)) { ?>
                                        <tr>
                                            <td class="text-right" colspan="4"><strong><?php echo display('vat_tax') ?> (<?php echo $settinginfo->vat ?? 0; ?>%)</strong></td>
                                            <td class="text-right"><strong><?php
                                    ...
                                    if ($orderinfo->order_status == 5) {} else {
