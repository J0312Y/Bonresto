...
foreach ($itemlist as $item) {
    ...
    if (!empty($item->itemnotes)) {echo " -" . $item->itemnotes;}
...
foreach ($iteminfo as $item) {
    ...
    if ($orderinfo->order_status != 4) {?><a class="btn btn-danger btn-sm btnrightalign" onclick="deletecart(<?php echo $item->row_id; ?>,<?php echo $item->order_id; ?>,<?php echo $item->menu_id ?>,<?php echo $item->varientid ?>,<?php echo $item->menuqty; ?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></a><?php }
...
?> <?php echo number_format($itemtotal, 3); ?> <?php if ($currency->position == 2) {echo $currency->curr_icon;}
...
?> </strong></td>
                            ...
                            <table class="table table-bordered bg-white">
                                <tr>
                                    <td class="text-right wpr_494"><strong><?php echo display('discount') ?><?php if ($settinginfo->discount_type == 0) {echo "(" . $currency->curr_icon . ")";} else {echo "(%)";}
...
?>
                                ...
                                <tr>
                                    <td class="text-right wpr_494"><strong><?php echo display('service_chrg') ?>(<?php if ($settinginfo->service_chargeType == 1) {echo "%";} else {echo $currency->curr_icon;}
...
?> <?php echo number_format($calvat, 3); ?> <?php if ($currency->position == 2) {echo $currency->curr_icon;}
...
?> </strong>
                            ...
                            <tr>
                                ...
                                <input name="orginattotal" id="orginattotal_update" type="hidden" value="<?php echo $calvat + $itemtotal + $sdamount; ?>" /><input name="grandtotal" id="grandtotal_update" type="hidden" value="<?php echo $calvat + $itemtotal + $sdamount; ?>" /><?php if ($currency->position == 1) {echo $currency->curr_icon;}
