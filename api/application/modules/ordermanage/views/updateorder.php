...
foreach ($itemlist as $item) {
    ...
    ?>">
                                            ...
                                            <div class="text-center"><h4><?php echo $item->ProductName; ?> (<?php echo $item->variantName; ?>)<?php
...
?> <?php echo number_format($itemtotal - $pdiscount, 3); ?> <?php
...
?>
                            ...
                            <table class="table table-bordered bg-white">
                                ...
                                <tr>
                                    <td class="text-right wpr_494"><strong><?php echo display('service_chrg') ?><?php

if ($settinginfo->service_chargeType == 0) {echo "(" . $currency->curr_icon . ")";} else {echo "(%)";}
...
?> <?php echo number_format($calvat, 3); ?> <?php
...
?> </strong>
                            ...
                            <tr>
                                ...
                                <input name="orginattotal" id="orginattotal_update" type="hidden" value="<?php echo $calvat + $itemtotal + $servicecharge - $discount; ?>" /><input name="grandtotal" id="grandtotal_update" type="hidden" value="<?php echo $calvat + $itemtotal + $servicecharge - $discount; ?>" /><?php
