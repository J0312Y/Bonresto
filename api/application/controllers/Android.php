        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!empty($reserveid)) {
                ...
                if ($reservationinfo != false) {
                    ...
                    $fields = [
                        'app_id' => '78ed384b-6ad2-47d0-9b57-c944ee4a2470',
                    ...
                    curl_setopt($ch, CURLOPT_HTTPHEADER, ['Content-Type: application/json; charset=utf-8', 'Authorization: Basic os_v2_app_pdwtqs3k2jd5bg2xzfco4sreoakffv5kk5buax5i7o74t7wdmlhv4dbz4mmynltvg5qcbhu5hxlvayaaoiq7lsccnj53xljwpbyophq']);
            ...
            if ($this->Api_v2_model->orderitem($orderid, $customerid)) {
                ...
                if ($paymentsatus == 5) {
                    ...
                    curl_setopt_array($curl3, [
                        ...
                        CURLOPT_HTTPHEADER => ['Content-Type: application/json; charset=utf-8', 'Authorization: Basic os_v2_app_pdwtqs3k2jd5bg2xzfco4sreoakffv5kk5buax5i7o74t7wdmlhv4dbz4mmynltvg5qcbhu5hxlvayaaoiq7lsccnj53xljwpbyophq'],
                    ]);
