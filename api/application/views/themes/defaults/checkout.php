...
/*check $taxsetting info*/
    ...
    if (!empty($this->session->userdata('couponcode'))) {
        ...
        ?></span><?php echo $coupon = $this->session->userdata('couponprice'); ?><span class="woocommerce-Price-currencySymbol"><?php
        ...
        if (!array_filter($slpayment)) {
            ?>
                                    <div class="payment-item">
                                            <input type="radio" name="card_type" id="payment_method_cre" data-parent="#payment" data-target="#description_cre" value="<?php echo $payment->payment_method_id; ?>" class="" <?php
            ...
            foreach ($slpayment as $selmethod) {
                ...
                if ($selmethod == $payment->payment_method_id) {
                    ?>
										<div class="payment-item">
                                            <input type="radio" name="card_type" id="payment_method_cre<?php echo $payment->payment_method_id; ?>" data-parent="#payment" data-target="#description_cre" value="<?php echo $payment->payment_method_id; ?>" class="" <?php
