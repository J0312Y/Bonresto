      ...
      <tbody>
        <?php if (!empty($payment_methods)) { 
          ...
          <tr>
            ...
            <td>
              <label class="switch">
                <input type="checkbox" class="toggle-status" data-id="<?= $method->payment_method_id; ?>" <?= $method->is_active ? 'checked' : ''; ?>>
...
$(document).ready(function() {
    $('.toggle-status').on('change', function() {
        ...
        $.ajax({
            ...
            type: "POST",
            data: { id: id, is_active: is_active, <?= $this->security->get_csrf_token_name(); ?>: '<?= $this->security->get_csrf_hash(); ?>' },
            dataType: "json",
