...
$(document).ready(function () {
    ...
    // Initialisation DataTable Online Order
    var onlineoredrlist = $('#Onlineorder').DataTable({
        ...
        footerCallback: function (row, data, start, end, display) {
            ...
            var total = api.column(9).data().reduce((a, b) => intVal(a) + intVal(b), 0);
            var pageTotal = api.column(9, { page: 'current' }).data().reduce((a, b) => intVal(a) + intVal(b), 0);
    ...
    setInterval(function () {
        ...
        load_unseen_notification(); // Rafraîchissement notifications
    }, 15000);
